/* HTML renderer */
/* $Id: renderer.c,v 1.17 2003/12/30 13:02:02 zas Exp $ */
		...
		struct document_options *options)
{
	...
	if (compare_opt_only_size(&document->options, options)) {
		...
		document_view->width = options->width;
		document_view->height = options->height;
	}
}

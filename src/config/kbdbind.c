...
/* $Id: kbdbind.c,v 1.113 2003/12/20 23:02:41 jonas Exp $ */
...
static struct default_kb default_main_keymap[] = {
	...
	{ ACT_GOTO_URL_HOME, 'H', 0 },
	{ ACT_ADD_BOOKMARK, 'a', 0 },
	{ ACT_ADD_BOOKMARK_LINK, 'A', 0 },
	{ ACT_BOOKMARK_MANAGER, 's', 0 },
	{ ACT_CACHE_MANAGER, 'C', 0 },
	{ ACT_COOKIE_MANAGER, 'K', 0 },
	{ ACT_DOWNLOAD_MANAGER, 'D', 0 },
	{ ACT_HISTORY_MANAGER, 'h', 0 },
	{ ACT_OPTIONS_MANAGER, 'o', 0 },
	{ ACT_KEYBINDING_MANAGER, 'k', 0 },
	{ ACT_COOKIES_LOAD, 'K', KBD_CTRL },
	{ ACT_QUIT, 'q', 0 },
	{ ACT_REALLY_QUIT, 'Q', 0 },
	{ ACT_DOCUMENT_INFO, '=', 0 },
	{ ACT_HEADER_INFO, '|', 0 },
	{ ACT_OPEN_NEW_TAB, 't', 0 },
	{ ACT_OPEN_LINK_IN_NEW_TAB, 'T', 0 },
	{ ACT_TAB_CLOSE, 'c', 0 },
	{ ACT_TAB_NEXT, '>', 0 },
	{ ACT_TAB_PREV, '<', 0 },
	{ ACT_TOGGLE_HTML_PLAIN, '\\', 0 },
	{ ACT_TOGGLE_NUMBERED_LINKS, '.', 0 },
	{ ACT_TOGGLE_DISPLAY_IMAGES, '*', 0 },
	{ ACT_TOGGLE_DOCUMENT_COLORS, '%', 0 },

/* $Id: sched.h,v 1.2 2002/03/16 22:03:09 pasky Exp $ */
...
void add_blacklist_entry(unsigned char *, bl_flags_type);
void del_blacklist_entry(unsigned char *, bl_flags_type);

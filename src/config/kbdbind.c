...
/* $Id: kbdbind.c,v 1.259 2004/10/13 16:12:10 zas Exp $ */
...
static struct strtonum main_action_table[MAIN_ACTIONS + 1] = {
	{ "none", ACT_MAIN_NONE, D_("Do nothing") },
	{ " *scripting-function*", ACT_MAIN_SCRIPTING_FUNCTION, NULL }, /* internal use only */
	{ "abort-connection", ACT_MAIN_ABORT_CONNECTION, D_("Abort connection") },
	{ "add-bookmark", ACT_MAIN_ADD_BOOKMARK, D_("Add a new bookmark") },
	{ "add-bookmark-link", ACT_MAIN_ADD_BOOKMARK_LINK, D_("Add a new bookmark using current link") },
	{ "add-bookmark-tabs", ACT_MAIN_ADD_BOOKMARK_TABS, D_("Bookmark all open tabs") },
	{ "auth-manager", ACT_MAIN_AUTH_MANAGER, D_("Open authentication manager") },
	{ "bookmark-manager", ACT_MAIN_BOOKMARK_MANAGER, D_("Open bookmark manager") },
	{ "cache-manager", ACT_MAIN_CACHE_MANAGER, D_("Open cache manager") },
	{ "cache-minimize", ACT_MAIN_CACHE_MINIMIZE, D_("Free unused cache entries") },
	{ "cookie-manager", ACT_MAIN_COOKIE_MANAGER, D_("Open cookie manager") },
	{ "cookies-load", ACT_MAIN_COOKIES_LOAD, D_("Reload cookies file") },
	{ "copy-clipboard", ACT_MAIN_COPY_CLIPBOARD, D_("Copy text to clipboard") },
	{ "document-info", ACT_MAIN_DOCUMENT_INFO, D_("Show information about the current page") },
	{ "download-manager", ACT_MAIN_DOWNLOAD_MANAGER, D_("Open download manager") },
	{ "exmode", ACT_MAIN_EXMODE, D_("Enter ex-mode (command line)") },
	{ "file-menu", ACT_MAIN_FILE_MENU, D_("Open the File menu") },
	{ "find-next", ACT_MAIN_FIND_NEXT, D_("Find the next occurrence of the current search text") },
	{ "find-next-back", ACT_MAIN_FIND_NEXT_BACK, D_("Find the previous occurrence of the current search text") },
	{ "forget-credentials", ACT_MAIN_FORGET_CREDENTIALS, D_("Forget authentication credentials") },
	{ "formhist-manager", ACT_MAIN_FORMHIST_MANAGER, D_("Open form history manager") },
	{ "frame-external-command", ACT_MAIN_FRAME_EXTERNAL_COMMAND, D_("Pass URI of current frame to external command") },
	{ "frame-maximize", ACT_MAIN_FRAME_MAXIMIZE, D_("Maximize the current frame") },
	{ "frame-next", ACT_MAIN_FRAME_NEXT, D_("Move to the next frame") },
	{ "frame-prev", ACT_MAIN_FRAME_PREV, D_("Move to the previous frame") },
	{ "goto-url", ACT_MAIN_GOTO_URL, D_("Open \"Go to URL\" dialog box") },
	{ "goto-url-current", ACT_MAIN_GOTO_URL_CURRENT, D_("Open \"Go to URL\" dialog box containing the current URL") },
	{ "goto-url-current-link", ACT_MAIN_GOTO_URL_CURRENT_LINK, D_("Open \"Go to URL\" dialog box containing the current link URL") },
	{ "goto-url-home", ACT_MAIN_GOTO_URL_HOME, D_("Go to the homepage") },
	{ "header-info", ACT_MAIN_HEADER_INFO, D_("Show information about the current page HTTP headers") },
	{ "history-manager", ACT_MAIN_HISTORY_MANAGER, D_("Open history manager") },
	{ "history-move-back", ACT_MAIN_HISTORY_MOVE_BACK, D_("Return to the previous document in history") },
	{ "history-move-forward", ACT_MAIN_HISTORY_MOVE_FORWARD, D_("Go forward in history") },
	{ "jump-to-link", ACT_MAIN_JUMP_TO_LINK, D_("Jump to link") },
	{ "keybinding-manager", ACT_MAIN_KEYBINDING_MANAGER, D_("Open keybinding manager") },
	{ "kill-backgrounded-connections", ACT_MAIN_KILL_BACKGROUNDED_CONNECTIONS, D_("Kill all backgrounded connections") },
	{ "link-download", ACT_MAIN_LINK_DOWNLOAD, D_("Download the current link") },
	{ "link-download-image", ACT_MAIN_LINK_DOWNLOAD_IMAGE, D_("Download the current image") },
	{ "link-download-resume", ACT_MAIN_LINK_DOWNLOAD_RESUME, D_("Attempt to resume download of the current link") },
	{ "link-external-command", ACT_MAIN_LINK_EXTERNAL_COMMAND, D_("Pass URI of current link to external command") },
	{ "link-follow", ACT_MAIN_LINK_FOLLOW, D_("Follow the current link") },
	{ "link-follow-reload", ACT_MAIN_LINK_FOLLOW_RELOAD, D_("Follow the current link, forcing reload of the target") },
	{ "link-menu", ACT_MAIN_LINK_MENU, D_("Open the link context menu") },
#ifdef CONFIG_LUA
	{ "lua-console", ACT_MAIN_LUA_CONSOLE, D_("Open a Lua console") },
#else
	{ "lua-console", ACT_MAIN_LUA_CONSOLE, D_("Open a Lua console (DISABLED)") },
#endif
	{ "mark-goto", ACT_MAIN_MARK_GOTO, D_("Go at a specified mark") },
	{ "mark-set", ACT_MAIN_MARK_SET, D_("Set a mark") },
	{ "menu", ACT_MAIN_MENU, D_("Activate the menu") },
	{ "move-cursor-down", ACT_MAIN_MOVE_CURSOR_DOWN, D_("Move cursor down") },
	{ "move-cursor-left", ACT_MAIN_MOVE_CURSOR_LEFT, D_("Move cursor left") },
	{ "move-cursor-right", ACT_MAIN_MOVE_CURSOR_RIGHT, D_("Move cursor right") },
	{ "move-cursor-up", ACT_MAIN_MOVE_CURSOR_UP, D_("Move cursor up") },
	{ "move-document-end", ACT_MAIN_MOVE_DOCUMENT_END, D_("Move to the end of the document") },
	{ "move-document-start", ACT_MAIN_MOVE_DOCUMENT_START, D_("Move to the start of the document") },
	{ "move-link-down", ACT_MAIN_MOVE_LINK_DOWN, D_("Move one link down") },
	{ "move-link-left", ACT_MAIN_MOVE_LINK_LEFT, D_("Move one link left") },
	{ "move-link-next", ACT_MAIN_MOVE_LINK_NEXT, D_("Move to the next link") },
	{ "move-link-prev", ACT_MAIN_MOVE_LINK_PREV, D_("Move to the previous link") },
	{ "move-link-right", ACT_MAIN_MOVE_LINK_RIGHT, D_("Move one link right") },
	{ "move-link-up", ACT_MAIN_MOVE_LINK_UP, D_("Move one link up") },
	{ "move-page-down", ACT_MAIN_MOVE_PAGE_DOWN, D_("Move downwards by a page") },
	{ "move-page-up", ACT_MAIN_MOVE_PAGE_UP, D_("Move upwards by a page") },
	{ "open-link-in-new-tab", ACT_MAIN_OPEN_LINK_IN_NEW_TAB, D_("Open the current link in a new tab") },
	{ "open-link-in-new-tab-in-background", ACT_MAIN_OPEN_LINK_IN_NEW_TAB_IN_BACKGROUND, D_("Open the current link a new tab in background") },
	{ "open-link-in-new-window", ACT_MAIN_OPEN_LINK_IN_NEW_WINDOW, D_("Open the current link in a new window") },
	{ "open-new-tab", ACT_MAIN_OPEN_NEW_TAB, D_("Open a new tab") },
	{ "open-new-tab-in-background", ACT_MAIN_OPEN_NEW_TAB_IN_BACKGROUND, D_("Open a new tab in background") },
	{ "open-new-window", ACT_MAIN_OPEN_NEW_WINDOW, D_("Open a new window") },
	{ "open-os-shell", ACT_MAIN_OPEN_OS_SHELL, D_("Open an OS shell") },
	{ "options-manager", ACT_MAIN_OPTIONS_MANAGER, D_("Open options manager") },
	{ "quit", ACT_MAIN_QUIT, D_("Open a quit confirmation dialog box") },
	{ "really-quit", ACT_MAIN_REALLY_QUIT, D_("Quit without confirmation") },
	{ "redraw", ACT_MAIN_REDRAW, D_("Redraw the terminal") },
	{ "reload", ACT_MAIN_RELOAD, D_("Reload the current page") },
	{ "rerender", ACT_MAIN_RERENDER, D_("Re-render the current page") },
	{ "reset-form", ACT_MAIN_RESET_FORM, D_("Reset form items to their initial values") },
	{ "resource-info", ACT_MAIN_RESOURCE_INFO, D_("Show information about the currently used resources") },
	{ "save-as", ACT_MAIN_SAVE_AS, D_("Save the current document in source form") },
	{ "save-formatted", ACT_MAIN_SAVE_FORMATTED, D_("Save the current document in formatted form") },
	{ "save-options", ACT_MAIN_SAVE_OPTIONS, D_("Save options"), },
	{ "save-url-as", ACT_MAIN_SAVE_URL_AS, D_("Save URL as") },
	{ "scroll-down", ACT_MAIN_SCROLL_DOWN, D_("Scroll down") },
	{ "scroll-left", ACT_MAIN_SCROLL_LEFT, D_("Scroll left") },
	{ "scroll-right", ACT_MAIN_SCROLL_RIGHT, D_("Scroll right") },
	{ "scroll-up", ACT_MAIN_SCROLL_UP, D_("Scroll up") },
	{ "search", ACT_MAIN_SEARCH, D_("Search for a text pattern") },
	{ "search-back", ACT_MAIN_SEARCH_BACK, D_("Search backwards for a text pattern") },
	{ "search-typeahead", ACT_MAIN_SEARCH_TYPEAHEAD, D_("Search link text by typing ahead") },
	{ "search-typeahead-link", ACT_MAIN_SEARCH_TYPEAHEAD_LINK, D_("Search link text by typing ahead") },
	{ "search-typeahead-text", ACT_MAIN_SEARCH_TYPEAHEAD_TEXT, D_("Search document text by typing ahead") },
	{ "search-typeahead-text-back", ACT_MAIN_SEARCH_TYPEAHEAD_TEXT_BACK, D_("Search document text backwards by typing ahead") },
	{ "show-term-options", ACT_MAIN_SHOW_TERM_OPTIONS, D_("Show terminal options dialog") },
	{ "submit-form", ACT_MAIN_SUBMIT_FORM, D_("Submit form") },
	{ "submit-form-reload", ACT_MAIN_SUBMIT_FORM_RELOAD, D_("Submit form and reload") },
	{ "tab-close", ACT_MAIN_TAB_CLOSE, D_("Close tab") },
	{ "tab-close-all-but-current", ACT_MAIN_TAB_CLOSE_ALL_BUT_CURRENT, D_("Close all tabs but the current one") },
	{ "tab-external-command", ACT_MAIN_TAB_EXTERNAL_COMMAND, D_("Pass URI of current tab to external command") },
	{ "tab-menu", ACT_MAIN_TAB_MENU, D_("Open the tab menu") },
	{ "tab-move-left", ACT_MAIN_TAB_MOVE_LEFT, D_("Move the current tab to the left") },
	{ "tab-move-right", ACT_MAIN_TAB_MOVE_RIGHT, D_("Move the current tab to the right") },
	{ "tab-next", ACT_MAIN_TAB_NEXT, D_("Next tab") },
	{ "tab-prev", ACT_MAIN_TAB_PREV,D_("Previous tab") },
	{ "toggle-css", ACT_MAIN_TOGGLE_CSS, D_("Toggle rendering of page using CSS") },
	{ "toggle-display-images", ACT_MAIN_TOGGLE_DISPLAY_IMAGES, D_("Toggle displaying of links to images") },
	{ "toggle-display-tables", ACT_MAIN_TOGGLE_DISPLAY_TABLES, D_("Toggle rendering of tables") },
	{ "toggle-document-colors", ACT_MAIN_TOGGLE_DOCUMENT_COLORS, D_("Toggle usage of document specific colors") },
	{ "toggle-html-plain", ACT_MAIN_TOGGLE_HTML_PLAIN, D_("Toggle rendering page as HTML / plain text") },
	{ "toggle-numbered-links", ACT_MAIN_TOGGLE_NUMBERED_LINKS, D_("Toggle displaying of links numbers") },
	{ "toggle-plain-compress-empty-lines", ACT_MAIN_TOGGLE_PLAIN_COMPRESS_EMPTY_LINES, D_("Toggle plain renderer compression of empty lines") },
	{ "toggle-wrap-text", ACT_MAIN_TOGGLE_WRAP_TEXT, D_("Toggle wrapping of text") },
	{ "view-image", ACT_MAIN_VIEW_IMAGE, D_("View the current image") },

	{ NULL, 0, NULL }
};

static struct strtonum edit_action_table[EDIT_ACTIONS + 1] = {
	{ "none", ACT_EDIT_NONE, D_("Do nothing") },
	{ " *scripting-function*", ACT_EDIT_SCRIPTING_FUNCTION, NULL }, /* internal use only */
	{ "auto-complete", ACT_EDIT_AUTO_COMPLETE, D_("Attempt to auto-complete the input") },
	{ "auto-complete-unambiguous", ACT_EDIT_AUTO_COMPLETE_UNAMBIGUOUS, D_("Attempt to unambiguously auto-complete the input") },
	{ "backspace", ACT_EDIT_BACKSPACE, D_("Delete character in front of the cursor") },
	{ "beginning-of-buffer", ACT_EDIT_BEGINNING_OF_BUFFER, D_("Go to the first line of the buffer") },
	{ "cancel", ACT_EDIT_CANCEL, D_("Cancel current state") },
	{ "copy-clipboard", ACT_EDIT_COPY_CLIPBOARD, D_("Copy text to clipboard") },
	{ "cut-clipboard", ACT_EDIT_CUT_CLIPBOARD, D_("Delete text from clipboard") },
	{ "delete", ACT_EDIT_DELETE, D_("Delete character under cursor") },
	{ "down", ACT_EDIT_DOWN, D_("Move cursor downwards") },
	{ "end", ACT_EDIT_END, D_("Go to the end of the page/line") },
	{ "end-of-buffer", ACT_EDIT_END_OF_BUFFER, D_("Go to the last line of the buffer") },
	{ "enter", ACT_EDIT_ENTER, D_("Follow the current link") },
	{ "home", ACT_EDIT_HOME, D_("Go to the start of the page/line") },
	{ "kill-to-bol", ACT_EDIT_KILL_TO_BOL, D_("Delete to beginning of line") },
	{ "kill-to-eol", ACT_EDIT_KILL_TO_EOL, D_("Delete to end of line") },
	{ "left", ACT_EDIT_LEFT,D_("Move the cursor left") },
	{ "next-item", ACT_EDIT_NEXT_ITEM, D_("Move to the next item") },
	{ "open-external", ACT_EDIT_OPEN_EXTERNAL, D_("Open in external editor") },
	{ "paste-clipboard", ACT_EDIT_PASTE_CLIPBOARD, D_("Paste text from the clipboard") },
	{ "previous-item", ACT_EDIT_PREVIOUS_ITEM, D_("Move to the previous item") },
	{ "redraw", ACT_EDIT_REDRAW, D_("Redraw the terminal") },
	{ "right", ACT_EDIT_RIGHT, D_("Move the cursor right") },
	{ "search-toggle-regex", ACT_EDIT_SEARCH_TOGGLE_REGEX, D_("Toggle regex matching (type-ahead searching)") },
	{ "up", ACT_EDIT_UP, D_("Move cursor upwards") },

	{ NULL, 0, NULL }
};

static struct strtonum menu_action_table[MENU_ACTIONS + 1] = {
	{ "none", ACT_MENU_NONE, D_("Do nothing") },
	{ " *scripting-function*", ACT_MENU_SCRIPTING_FUNCTION, NULL }, /* internal use only */
	{ "cancel", ACT_MENU_CANCEL, D_("Cancel current state") },
	{ "delete", ACT_MENU_DELETE, D_("Delete character under cursor") },
	{ "down", ACT_MENU_DOWN, D_("Move cursor downwards") },
	{ "end", ACT_MENU_END, D_("Go to the end of the page/line") },
	{ "enter", ACT_MENU_ENTER, D_("Follow the current link") },
	{ "expand", ACT_MENU_EXPAND, D_("Expand item") },
	{ "home", ACT_MENU_HOME, D_("Go to the start of the page/line") },
	{ "left", ACT_MENU_LEFT,D_("Move the cursor left") },
	{ "mark-item", ACT_MENU_MARK_ITEM, D_("Mark item") },
	{ "next-item", ACT_MENU_NEXT_ITEM, D_("Move to the next item") },
	{ "page-down", ACT_MENU_PAGE_DOWN, D_("Move downwards by a page") },
	{ "page-up", ACT_MENU_PAGE_UP, D_("Move upwards by a page") },
	{ "previous-item", ACT_MENU_PREVIOUS_ITEM, D_("Move to the previous item") },
	{ "redraw", ACT_MENU_REDRAW, D_("Redraw the terminal") },
	{ "right", ACT_MENU_RIGHT, D_("Move the cursor right") },
	{ "search", ACT_MENU_SEARCH, D_("Search for a text pattern") },
	{ "select", ACT_MENU_SELECT, D_("Select current highlighted item") },
	{ "unexpand", ACT_MENU_UNEXPAND, D_("Collapse item") },
	{ "up", ACT_MENU_UP, D_("Move cursor upwards") },

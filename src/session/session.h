/* $Id: session.h,v 1.141 2004/06/10 16:05:53 jonas Exp $ */
...
struct session *init_session(struct terminal *term, struct session *ses, struct uri *uri, int in_background);

...
/* $Id: connection.c,v 1.2 2003/01/02 05:37:44 pasky Exp $ */
...
struct s_msg_dsc msg_dsc[] = {
	{S_WAIT,		_(T_WAITING_IN_QUEUE)},
	{S_DNS,			_(T_LOOKING_UP_HOST)},
	{S_CONN,		_(T_MAKING_CONNECTION)},
	{S_SSL_NEG,		_(T_SSL_NEGOTIATION)},
	{S_SENT,		_(T_REQUEST_SENT)},
	{S_LOGIN,		_(T_LOGGING_IN)},
	{S_GETH,		_(T_GETTING_HEADERS)},
	{S_PROC,		_(T_SERVER_IS_PROCESSING_REQUEST)},
	{S_TRANS,		_(T_TRANSFERRING)},

	{S_WAIT_REDIR,		_(T_WAITING_FOR_REDIRECT_CONFIRMATION)},
	{S_OK,			_(T_OK)},
	{S_INTERRUPTED,		_(T_INTERRUPTED)},
	{S_EXCEPT,		_(T_SOCKET_EXCEPTION)},
	{S_INTERNAL,		_(T_INTERNAL_ERROR)},
	{S_OUT_OF_MEM,		_(T_OUT_OF_MEMORY)},
	{S_NO_DNS,		_(T_HOST_NOT_FOUND)},
	{S_CANT_WRITE,		_(T_ERROR_WRITING_TO_SOCKET)},
	{S_CANT_READ,		_(T_ERROR_READING_FROM_SOCKET)},
	{S_MODIFIED,		_(T_DATA_MODIFIED)},
	{S_BAD_URL,		_(T_BAD_URL_SYNTAX)},
	{S_TIMEOUT,		_(T_RECEIVE_TIMEOUT)},
	{S_RESTART,		_(T_REQUEST_MUST_BE_RESTARTED)},
	{S_STATE,		_(T_CANT_GET_SOCKET_STATE)},

	{S_HTTP_ERROR,		_(T_BAD_HTTP_RESPONSE)},
	{S_HTTP_100,		_(T_HTTP_100)},
	{S_HTTP_204,		_(T_NO_CONTENT)},

	{S_FILE_TYPE,		_(T_UNKNOWN_FILE_TYPE)},
	{S_FILE_ERROR,		_(T_ERROR_OPENING_FILE)},

	{S_FTP_ERROR,		_(T_BAD_FTP_RESPONSE)},
	{S_FTP_UNAVAIL,		_(T_FTP_SERVICE_UNAVAILABLE)},
	{S_FTP_LOGIN,		_(T_BAD_FTP_LOGIN)},
	{S_FTP_PORT,		_(T_FTP_PORT_COMMAND_FAILED)},
	{S_FTP_NO_FILE,		_(T_FILE_NOT_FOUND)},
	{S_FTP_FILE_ERROR,	_(T_FTP_FILE_ERROR)},
#ifdef HAVE_SSL
	{S_SSL_ERROR,		_(T_SSL_ERROR)},
#else
	{S_NO_SSL,		_(T_NO_SSL)},
#endif
	{0,			NULL}

...
/* $Id: hash.c,v 1.1 2002/05/18 13:41:39 pasky Exp $ */
...
hash_value mkhash( k, length, initval)
 ...
 register hash_value initval;  /* the previous hash, or an arbitrary value */
 {
    ...
    while (len >= 12)
    {
       a += ((k[0]) +((hash_value)(k[1])<<8) +((hash_value)(k[2])<<16) +((hash_value)(k[3])<<24));
       b += ((k[4]) +((hash_value)(k[5])<<8) +((hash_value)(k[6])<<16) +((hash_value)(k[7])<<24));
       c += ((k[8]) +((hash_value)(k[9])<<8) +((hash_value)(k[10])<<16)+((hash_value)(k[11])<<24));
       mix(a,b,c);
       k += 12; len -= 12;
    }

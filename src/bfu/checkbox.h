/* $Id: checkbox.h,v 1.6 2003/06/27 20:34:54 zas Exp $ */
...
void min_max_checkboxes_width(struct terminal *term, int intl, unsigned char **texts, int *minwidth, int *maxwidth);

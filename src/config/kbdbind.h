/* $Id: kbdbind.h,v 1.179 2005/07/10 01:38:03 miciah Exp $ */
...
struct keybinding *add_keybinding(enum keymap_id keymap_id, action_id_T action_id, struct term_event_keyboard *kbd, int event_id);

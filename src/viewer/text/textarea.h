/* $Id: textarea.h,v 1.25 2004/06/23 13:18:09 jonas Exp $ */
...
void textarea_edit(int, struct session *, struct form_state *, struct document_view *, struct link *);
void menu_textarea_edit(struct terminal *term, void *xxx, struct session *ses);

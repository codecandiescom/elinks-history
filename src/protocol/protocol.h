/* $Id: protocol.h,v 1.7 2003/06/26 21:09:58 pasky Exp $ */
...
void (*get_protocol_handler(unsigned char *))(struct connection *);
void (*get_protocol_external_handler(unsigned char *))(struct session *, unsigned char *);

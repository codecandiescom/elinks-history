...
static const char *const yytname[] =
	{ "$", "error", "$undefined.", "'?'", "'|'",
	"'&'", "EQUOP2", "CMPOP2", "ADDOP2", "MULOP2", "'!'", "NUMBER", "':'",
		"'n'", "'('", "')'",
	"start", "exp", NULL
};
#endif
...
#line 198 "plural.y"
			{
				yyval.exp =
					new_exp_2(yyvsp[-1].op, yyvsp[-2].exp,
						  yyvsp[0].exp);
				;
				break;
			}
...
void internal_function FREE_EXPRESSION(exp)
struct expression *exp;
{
	if (exp == NULL)
		return;

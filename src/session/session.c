...
/* $Id: session.c,v 1.546 2004/07/26 22:40:58 zas Exp $ */
...
static void tabwin_func(struct window *tab, struct term_event *ev, int xxx);
...
static void
tabwin_func(struct window *tab, struct term_event *ev, int xxx)
{

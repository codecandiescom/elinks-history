/* Menu system */
/* $Id: menu.c,v 1.146 2003/10/18 22:00:54 pasky Exp $ */
...
static struct menu_item file_menu11[] = {
	INIT_MENU_ITEM(N_("Open in new ~tab"), "", open_in_new_tab, (void *) 0, FREE_NOTHING, 0),
	INIT_MENU_ITEM(N_("Open in new tab in ~background"), "", open_in_new_tab_in_background,

...
/* $Id: core.c,v 1.126 2003/11/14 02:06:29 miciah Exp $ */
...
#define L_EDIT_BMK_WIDGETS_COUNT 5
	...
	data = (struct lua_dlg_data *)&dlg->widgets[L_EDIT_BMK_WIDGETS_COUNT];
	data->state = S;
...
l_xdialog(LS)
{
	...
	data = (struct lua_xdialog_data *)&dlg->widgets[nitems];
	data->state = S;
